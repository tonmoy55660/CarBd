...
session_start();
$post_data = array();
$post_data['store_id'] = "abc5dca8eaadf0ce";
$post_data['store_passwd'] = "abc5dca8eaadf0ce@ssl";
$post_data['total_amount'] = $_GET['price'];
$post_data['currency'] = "BDT";
$post_data['tran_id'] = "SSLCZ_TEST_".uniqid();
$post_data['success_url'] = "http://localhost/carBD/success.php";
...
$post_data['ship_name'] = "testabcp6td";
