        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add your renting car details here :</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="insert_rent.php" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  <label for="exampleInputPassword1">Expected Price per day ::</label>
